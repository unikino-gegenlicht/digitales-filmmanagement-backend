...
func GetAllRegisterItems(w http.ResponseWriter, r *http.Request) {
	...
	rows, err := globals.SqlQueries.Query(globals.Database, "get-register-items")
	if err != nil {
